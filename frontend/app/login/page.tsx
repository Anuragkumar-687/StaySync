  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .forgotrow { display: flex; justify-content: flex-end; margin-top: -5px; }
        .forgot { font-size: 0.71rem; color: #818cf8; text-decoration: none; font-weight: 500; transition: color 0.2s; }
      ...
      <div className="auth-wrap">
        ...
        <div className="auth-card">
          ...
          <div className="csub">Sign in to your account to continue managing your hostel.</div>

          <div className="tabs">
            <Link href="/login" className="tab active">Sign In</Link>
            <Link href="/register" className="tab">Create Account</Link>
          </div>
